...
- ("st_model",)                 — model nomi
- ("sched_input",)              — rejalashtirilgan xabar so'rovi
"""
...
from .schedule import handle_schedule_text
...
async def handle_owner_text(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    elif kind == "sched_input":
        await handle_schedule_text(update, context, state)
